// DesktopTrayIcon.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "DesktopTrayIcon.h"
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_DESKTOPTRAYICON, szWindowClass, MAX_LOADSTRING);
