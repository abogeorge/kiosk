// Kyosk.cpp : Defines the entry point for the application.
//
                     ...
                     _In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_KYOSK, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_KYOSK));

	el::Configurations conf("my-conf.conf"); //// Load logger configuration from file
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_KYOSK));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_KYOSK);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	LPCTSTR titleBalloon = L"Changed Desktop!";
	LPCTSTR contentBalloon = L"";
